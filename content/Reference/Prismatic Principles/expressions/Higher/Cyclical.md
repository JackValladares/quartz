<div class="prisma-header prisma-cyclical">
  <div class="prisma-banner">
    <img src="/images/cyclical-rune.png" alt="Disruptive Rune" class="prisma-banner-icon"/>
    <span class="prisma-banner-title">Cyclical Prisma</span>
  </div>
...
**Cyclical Prisma is distinctly Purple** **and takes on natures of both its components** - dense and potent, bobbing just along the surface of physical matter…sinking into it before hovering above.Prisma with an Expression representing equal parts **Decay** and **Iteration** is known as **Cyclical** **Prisma**, representing **Flux** as the forces of Creation and Destruction in tandem.
