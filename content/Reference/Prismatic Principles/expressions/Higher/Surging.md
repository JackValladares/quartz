<div class="prisma-header prisma-surging">
  <div class="prisma-banner">
    <img src="/images/surging-rune.png" alt="Surging Rune" class="prisma-banner-icon"/>
    <span class="prisma-banner-title">Surging Prisma</span>
  </div>
  <div class="prisma-banner-tags">
    <strong>Fervor</strong>
  </div>
</div>
