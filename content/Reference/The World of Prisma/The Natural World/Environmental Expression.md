Every Biome in the Prismatic Realms has its own _Environmental Expression_ - describing the natural forces at work and the [[Prismatic Expression|Expression]] with which they [[Prismatic Stain|Stain]] the local Prisma.

## Lower Order Environments
...
In such a case, a [[Disruptive]] **Jungle** might evolve from a simple **[[Stratic|Blue]]**/**[[Morphic|Yellow]]** Overlap – the simple intersection of Flow and Creation – into an environment that embodies **Foment** run Rampant.
